    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- Dynamic content for course details -->
    ...
    $(document).ready(function () {
        ...
        function initializeCards(data) {
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="card text-center">
                            ...
                            <div class="card-body">
                                ...
                                <!-- Button to view course details (opens modal) -->
            ...
            $('.view-details-btn').on('click', function () {
                // Retrieve data attributes from the button and set modal content
        ...
        function filterCards(searchText, data) {
            // Use filter to find matching courses based on title or description
